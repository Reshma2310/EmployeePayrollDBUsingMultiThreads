...
namespace EmployeePayrollTesting
{
    public class Tests
    {
        ...
        public void GivenListOfMultipleEmployee_AddToPayrollDataBase_TestTimeWithAndWithout_MutltiThreading()
        {
            ...
            employee.Add(new EmployeePayrollModelClass(Id: 17, Name: "Vahidha", Salary: 45000, Start: DateTime.Now, Gender: "Female", PhoneNo: 6666754325, Address: "US", Department: "Finance", BasicPay: 45000, Deductions: 1900, TaxablePay: 1300, NetPay: 41800));
            employee.Add(new EmployeePayrollModelClass(Id: 17, Name: "Khajabi", Salary: 33000, Start: DateTime.Now, Gender: "Female", PhoneNo: 6664444325, Address: "India", Department: "Management", BasicPay: 33000, Deductions: 1500, TaxablePay: 1100, NetPay: 30800));
